...
public class MenuItemCancelCheckoutAction implements EventHandler<ActionEvent> {
	private static final Logger LOGGER = Logger.getLogger(MenuItemCancelCheckoutAction.class.getName());

	private final Repository repository = Repository.getInstance();
	private final TableView result;

	public MenuItemCancelCheckoutAction(MenuItem destroyObject, TableView result) {
		this.result = result;
